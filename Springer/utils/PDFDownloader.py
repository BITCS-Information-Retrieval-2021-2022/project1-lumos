...
class PDFManager():
    ...
    def downloadFile(self, url, fileName):
        ...
        permutive-id=8efad603-1257-48a3-9324-1b74bf4da263;\
             __gads=ID=0904beb04aaa075d-227d78a77dce00cf:T=1635751753:S=ALNI_Mbrb7m9uHZsnnzAv1frWjxnd2VCBQ;\
                  _uetvid=1fb39c0049ef11ecb0b0cdf7dd86a8b4; Hm_lvt_92dc0ba795afae15bcf6ac1d3276202e=1637410286,1637499346,1637989794,1638076157;\
                       _fbp=fb.1.1638076884334.695362321; cto_bundle=yDyTC19GTnBHYnlwdEhyVExVWG8lMkYxRElSN0p3UXE0NWRjU1l6ZUZJNlp6JTJGJTJGTFRrS2tlJTJ\
                           GemtYd3UzeEd1aTJoNnBLZk82bDF2cU9RN3VsJTJGaHJjUmlVZU53UjZHRXRFWEhESSUyRkhvSzBPekE3dUJJT3p3JTJCajZSOW5tdUpuOG9qOEE1eHI3T1ZVT\
                               E85R1dUWVQzV0ZnOUVUTGZoUSUzRCUzRA; OptanonConsent=isIABGlobal=false&datestamp=Sun+Nov+28+2021+15%3A52%3A39+GMT%2B0800\
                                       ...
                                       e&groups=C0001%3A1%2CC0002%3A1%2CC0003%3A1%2CC0004%3A1%2CC0005%3A1%2CC0008%3A1%2CC0009%3A1%2Cgad%3A1&\
                                           geolocation=%3B&AwaitingReconsent=false; permutive-session=%7B%22session\
                                               _id%22%3A%222c734ae7-2f56-4652-868d-ad1172f24ea2%22%2C%22last_updated%22%3A%22202\
                                                   1-11-28T07%3A52%3A40.491Z%22%7D; trackid=ca93cca5035a404680faa1425; idp_sessio\
                                                       n=sVERSION_13e885d12-b77a-4251-b661-bbbdce217474; idp_session_http=hVERSION_1ce7\
                                                           9fa9d-fa2f-4032-8078-0c27849a9227; sim-inst-token=1::1639252759517:de6a3ff3'
        ...
        '''
        r = requests.get(url, headers={'User-Agent': user_agent, 'cookie': cookie_copy_from_web}, stream=True, allow_redirects=False)
        print(r)
        str_r = str(r)
    ...
    def run(self, poolSize=2):
        ...
        for index in range(0, count):
            ...
            args.append((None, {'url': self.pdfUrlsUseful[index], "fileName": "/Users/jamesmark/Desktop/" + fileName}))
        # print(args)
        # 线程池大小
        if count < poolSize:
            poolSize = count
