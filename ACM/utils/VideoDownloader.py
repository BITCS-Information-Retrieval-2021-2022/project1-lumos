...
class VideoManager():
    ...
    def getVideoUrlsfromDB(self):
        ...
        urls = [
            url['video_download'] for url in col.find({"videoVisit": False})
        ]
        # print(urls)
    ...
    def updateUrl(self, url, filePath):
        ...
        col.update_one({"video_download": url},
                       {"$set": {
                           "video_path": filePath
                       }})
    ...
    def downloadVideo(self, url):
        ...
        print(url_)
        # url_ = "https://dl.acm.org/action/" + "downloadSupplement?doi=10.1145%2F30\
        # 53332&file=1938-imwut-2017_vol1issue1.mp4"
